...
#define I2C_TAS5766M_MASTER_NUM I2C_MASTER_NUM /*!< I2C port number for master dev */
...
typedef enum {
    TAS5766M_CTRL_DEEP_SLEEP = 0x00, // Deep Sleep
    TAS5766M_CTRL_SLEEP      = 0x01, // Sleep
    TAS5766M_CTRL_HI_Z       = 0x02, // Hi-Z
    TAS5766M_CTRL_PLAY       = 0x03, // Play
    TAS5766M_CTRL_MUTE       = 0x08  // Play
} TAS5766M_CTRL_STATE;

typedef enum {
    TAS5766M_DAC_MODE_BTL  = 0x00, // Bridge tied load
    TAS5766M_DAC_MODE_PBTL = 0x01 // Parallel load
} TAS5766M_DAC_MODE;
...
typedef struct {
    bool                     is_muted;
    bool                     is_powered;
    int8_t                   eq_gain[TAS5766M_EQ_BANDS];
    TAS5766M_CTRL_STATE      state;
    TAS5766M_MIXER_MODE      mixer_mode;
} TAS5766_STATE;
...
#define TAS5766M_VOLUME_MAX	255                 // Mute
#define TAS5766M_VOLUME_DEFAULT	48              //  +0 Db
#define TAS5766M_VOLUME_MIN	0                   // +24 Db

#define TAS5766M_VOLUME_PCT_MIN	0               // Mute
#define TAS5766M_VOLUME_PCT_DEFAULT	100         //  +0 Db
#define TAS5766M_VOLUME_PCT_MAX	124             // +24 Db


/**
     * @brief Power up and initialize TAS5766 codec chip
     *
    ...
    /** 
     * @brief Get the current state of the TAS5766M
     * 
    ...
    */
    ...
    /**
     * @brief Get the power state of the TAS5766M
     * 
     * @param state: Pointer to the state variable
     * 
     * @return
    ...
    /**
     * @brief Map the TAS5766M_CTRL_STATE to a string
     * 
